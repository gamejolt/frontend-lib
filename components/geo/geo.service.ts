	...
	static getCountries()
	{
		if ( !this.countries.length ) {
			this.countries = [
				...
				{ code: 'bq', name: Translate.$gettext( 'Bonaire, Saint Eustatius and Saba' ) },
				...
				{ code: 'io', name: Translate.$gettext( 'British Indian Ocean Territory' ) },
				...
				{ code: 'cd', name: Translate.$gettext( 'Democratic Republic of the Congo' ) },
				...
				{ code: 'hm', name: Translate.$gettext( 'Heard Island and McDonald Islands' ) },
				...
				{ code: 'vc', name: Translate.$gettext( 'Saint Vincent and the Grenadines' ) },
				...
				{ code: 'gs', name: Translate.$gettext( 'South Georgia and the South Sandwich Islands' ) },
				...
				{ code: 'um', name: Translate.$gettext( 'United States Minor Outlying Islands' ) },
