angular.module( 'gj.Game.PlayModal' ).service( 'Game_PlayModalOld', function( $q, $modal, $state, Growls, HistoryTick, Environment, Popover, Analytics, Game_Build )
{
	var _this = this;
	...
	this.show = function( _game, _build )
	{
		...
		var modalInstance = $modal.open( {
			...
			templateUrl: '/lib/gj-lib-client/components/game/play-modal/play-modal-old.html',
			controller: 'Game_PlayModalOldCtrl',
