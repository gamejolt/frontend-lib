angular
	.module('gj.ExpandWhen')
	.directive('gjExpandWhen', function($timeout, $transition, $parse) {
		return {
			restrict: 'EA',
			transclude: true,
			scope: true,
			...
			template:
				'<div collapse="isCollapsed"><div ng-if="isTranscluded" class="clearfix" ng-transclude></div></div>',
			link: {
