angular.module( 'gj.UiTree.Placeholder' ).directive( 'gjUiTreePlaceholder', function( $interpolate, treeConfig )
{
	...
	return {
		link: {
			pre: function( scope, element, attrs )
			{
				...
				{
					treeConfig.placeholderClass = defaultPlaceholder + ' ' + placeholderClass;
				}
			}
		}
	};
