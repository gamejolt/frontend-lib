...
import * as View from '!view!./pagination.html?style=./pagination.styl';
...
export class AppPagination extends Vue
{
	...
	@Prop( { type: String, default: 'page' } ) queryParam: string;
	...
	{
		return Object.assign( {}, this.$route.query, { [this.queryParam || 'page']: page } );
	}
