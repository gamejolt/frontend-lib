...
{
	[
		{ code: 400, template: require( './error-400.html' ) },
		{ code: 403, template: require( './error-403.html' ) },
		{ code: 404, template: require( './error-404.html' ) },
		{ code: 500, template: require( './error-500.html' ) },
	]
	...
	$stateProvider.state( 'error-offline', {
		...
		templateUrl: require( './error-offline.html' ),
		controllerAs: 'ctrl',
