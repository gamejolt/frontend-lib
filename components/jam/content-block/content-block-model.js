angular.module( 'gj.Jam.ContentBlock' ).factory( 'Jam_ContentBlock', function( $q, Model, Environment, Api )
{
	...
	{
		return Api.sendRequest( '/jams/manage/jams/content/get-block/' + blockId ).then( function( response )
		{
