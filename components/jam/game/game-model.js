angular.module( 'gj.Jam.Game' ).factory( 'Jam_Game', function( Model, User, Environment, Api, Jam_Award )
{
	...
	{
		var _this = this;
		return Api.sendRequest( '/jams/manage/jams/games/set-game-visibility/' + jamId + '/' + this.id + '/0', {} ).then( function()
		{
	...
	{
		var _this = this;
		return Api.sendRequest( '/jams/manage/jams/games/set-game-visibility/' + jamId + '/' + this.id + '/1', {} ).then( function()
		{
	...
	{
		var _this = this;
		return Api.sendRequest( '/jams/manage/jams/games/approve-entry/' + jamId + '/' + this.id, {} ).then( function()
		{
	...
	{
		var _this = this;
		return Api.sendRequest( '/jams/manage/jams/games/reject-entry/' + jamId + '/' + this.id, {} ).then( function()
		{
