angular.module( 'gj.Jam.VotingCategory' ).factory( 'Jam_VotingCategory', function( $q, Model, Environment, Api )
{
	...
	Jam_VotingCategory.prototype.$save = function()
	{
		...
		if ( !this.id ) {
			return this.$_save( '/jams/manage/jams/voting/add-category/' + this.jam_id, 'jamVotingCategory' );
		}
		else {
